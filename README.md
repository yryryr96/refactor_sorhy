...
| 2 | 진행바 | 목표 점수인 10,000점을 시각화해서 볼 수 있는 그래프입니다. |
| 3 | 콤보현황판 | 노트를 친 타이밍을 판정해서 누적된 콤보가 나타납니다. |
| 4 | 판정현황판 | 노트를 친 타이밍을 판정해서 얼마나 적절하게 쳤는지 애니메이션 효과와 함께 나타납니다. |
| 5 | 원노트 | 점점 줄어드는 원이 해당 노트의 테두리와 겹치는 타이밍에 클릭하는 노트입니다. |
| 6 | 롱노트 | 점점 줄어드는 원이 해당 노트의 테두리와 겹치는 타이밍에 드래그하는 노트입니다 |
